...
public class ArbolPanel extends JPanel implements MouseListener {
    ...
    private ListaDoble<Venta> obtenerVentasPersona(String nombrePersona) {
        File archivoVentas = new File("C:\\Users\\Luis Gil\\Documents\\practico\\ventas.txt"); // Reemplaza "ruta_archivo_ventas.txt" con la ruta correcta del archivo de ventas
