...
public class DibujoArbol {
    ...
    public void dibujarNodo(Arbol.Nodo<String> nodo, int x, int y, Graphics g) {
        ...
        for (Arbol.Nodo<String> hijo : nodo.getHijos()) {
            ...
            g.drawLine(xNodo + TAMANO_NODO / 2, y + TAMANO_NODO / 2, xHijo + (avanzar - ESPACIO_HORIZONTAL) / 2,
                    yHijo + TAMANO_NODO / 2);
        ...
        g.fillOval(xNodo, y, TAMANO_NODO, TAMANO_NODO);
        g.setColor(Color.black);
        g.drawOval(xNodo, y, TAMANO_NODO, TAMANO_NODO);
